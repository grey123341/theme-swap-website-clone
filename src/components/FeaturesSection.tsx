    ...
    <section className="relative bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center space-y-8 mb-16">
          <div className="inline-block">
            <div className="bg-white/20 backdrop-blur-sm rounded-full px-6 py-2 mb-4">
              <span className="text-white/90 font-medium text-sm tracking-wide">✨ PREMIUM FEATURES</span>
            </div>
          </div>
          ...
          {features.map((feature, index) => (
            <div key={index} className="group relative">
              ...
              <div className="absolute -top-3 -right-3 z-20">
                <div className="bg-gradient-to-r from-orange-400 to-red-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg transform rotate-12 group-hover:rotate-0 transition-transform duration-300">
                  {feature.highlight}
                </div>
              </div>
              ...
              <Card className="relative bg-white/95 backdrop-blur-md border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 group-hover:-translate-y-2 overflow-hidden h-full">
                ...
                <CardContent className="relative p-8 text-center space-y-6 h-full flex flex-col justify-center">
                  ...
                  <div className="relative mx-auto">
                    <div className="w-20 h-20 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
                      <feature.icon className="w-10 h-10 text-blue-600 group-hover:text-blue-700 transition-colors duration-300" />
                    </div>
                    
                    {/* Animated Ring */}
                    <div className="absolute inset-0 w-20 h-20 rounded-2xl border-2 border-blue-300 opacity-0 group-hover:opacity-100 animate-ping"></div>
                  </div>
                  
                  {/* Title with Animation */}
                  <h3 className="text-lg font-bold text-gray-800 leading-tight group-hover:text-blue-800 transition-colors duration-300">
                    {feature.title}
                  </h3>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-8 py-4">
